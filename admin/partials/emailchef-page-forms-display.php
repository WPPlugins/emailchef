<h1>eMailChef Forms</h1>
<p><?php echo sprintf(__('Connect contact forms to automatically populate your <a target="_blank" href="%s">eMailChef</a> lists on every submission.', 'wordpress'),'http://emailchef.com/'); ?></p>
<p><?php echo __('These are the contact forms found in your site:', 'wordpress'); ?></p>
<script>
        ...
        foreach ($forms as $form) { $totFormNum++;
            ...
            <div class="form control-section accordion-section
                ...
                <div class="accordion-section-title"
                     ...
                     ?>">
                    <?php echo $form['title'] ?>
                    <span class="not-connected"><?php echo __('warning: connection required!', 'wordpress'); ?></span>
                </div>
                <div class="accordion-section-content">
                    <div class="loading">
                        <?php echo __('Loading..', 'wordpress');
                        ?>
                    </div>
                    <div class="content">
                    </div>
